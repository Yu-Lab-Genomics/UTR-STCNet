from UTR_MT.transformer_utils import get_logger
...
def token2map(token_dict):
    ...
    x = token_dict['x']
    H, W = token_dict['map_size']  # 不需要
    # step_N = token_dict['map_size']
    H_init, W_init = token_dict['init_grid_size'] # 不需要
    # N_init = token_dict['init_grid_size'] # 不需要
